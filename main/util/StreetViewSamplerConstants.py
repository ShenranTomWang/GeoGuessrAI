...
TESTINGSET_PROMPTS = [
    "Find sushi restaurants in Tokyo, Japan.".replace(" ", "+"),
    "Show me coffee shops in New York, USA.".replace(" ", "+"),
    "Locate gas stations in Paris, France.".replace(" ", "+"),
    "Discover tourist attractions in Rome, Italy.".replace(" ", "+"),
    "Find pharmacies in Rio de Janeiro, Brazil.".replace(" ", "+"),
    "Find hotels near the Eiffel Tower in Paris, France.".replace(" ", "+"),
    "Explore parks in Sydney, Australia.".replace(" ", "+"),
    "Locate shopping centers in London, UK.".replace(" ", "+"),
    "Find hospitals in Mumbai, India.".replace(" ", "+"),
    "Where are the closest ATMs to the Pyramids of Giza, Egypt?".replace(" ", "+"),
    "Find parking areas in Los Angeles, USA.".replace(" ", "+"),
    "Locate public transportation near the Great Wall of China.".replace(" ", "+"),
    "Show me libraries in Berlin, Germany.".replace(" ", "+"),
    "Find museums in Amsterdam, Netherlands.".replace(" ", "+"),
    "Find bars and nightlife spots in Barcelona, Spain.".replace(" ", "+"),
    "Locate bakeries in Istanbul, Turkey.".replace(" ", "+"),
    "Discover parks in Cape Town, South Africa.".replace(" ", "+"),
    "Find ice cream shops in Moscow, Russia.".replace(" ", "+"),
    "Where are the nearest pharmacies to the Statue of Liberty, USA?".replace(" ", "+"),
    "Find historic sites in Kyoto, Japan.".replace(" ", "+")
]
